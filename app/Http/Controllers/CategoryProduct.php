...
class CategoryProduct extends Controller
{
    ...
    public function save_category_product(Request $request){  //request la yeu cau
        ...
        if(empty($request->category_product_id)) {
            ...
            $data['category_name'] = $request->category_product_id;
    ...
    public function update_category_product(Request $request,$category_product_id){
        ...
        DB::table('tbl_category_product')->where('category_name',$category_product_id)->update($data);
        Session::put('message','Cập nhật danh mục sản phẩm thành công!');
        return Redirect::to('all-category-product');  // tra ve lai all category
    }
    public function delete_category_product($category_product_id){
        DB::table('tbl_category_product')->where('category_name',$category_product_id)->delete();
